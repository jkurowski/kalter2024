...
@section('content')
    <main class="with-bigger-section-spacing">
        ...
        @include('layouts.partials.page-header', ['h1' => $page->title, 'desc' => 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor.', 'header' => 'img/kontakt_bg.webp'])
