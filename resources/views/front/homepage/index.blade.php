        ...
        <div data-slick='<?= json_encode($hero_slider_options) ?>' class="hero-slider">
            ...
            <div class="hero-slide position-relative">
                <div class="position-absolute top-0 start-0 w-100 h-100 hero-slide-image-container">
                    <img src="<?= $row['image_url'] ?>" alt="" class="hero-slide-image w-100 h-100 object-fit-cover" loading="eager" width="1655" height="680">
                </div>
                    ...
                    <div class="col-8 offset-2 col-xxl-4  offset-xxl-4 ">
                        ...
                        <div class="mt-30 hero-slide-button">
                            <a href="<?= $row['button_url']; ?>" class="btn btn-primary btn-with-icon">
                                    <?= $row['button_text']; ?>
                                <svg class="mb-1" xmlns="http://www.w3.org/2000/svg" width="6.073" height="11.062" viewBox="0 0 6.073 11.062">
                ...
                <div class="col-12 col-md-6 offset-md-3">
                    <div style="--translate-x: 0;" class="position-relative text-center d-flex flex-column justify-content-center align-items-center section-header text-secondary">
                        ...
                        <h2 class="fw-bold text-center text-uppercase">
                            ...
                            <span class="fw-900 fs-4 d-block text-center text-primary text-shadow" data-aos="fade-up" data-aos-delay="400">
                                Promocje
                            </span>
                        </h2>
                    </div>
                ...
                640 000 Zł
                        ...
                        <div class="small mb-40">
                            <table class="w-100">
                                <tbody>
                                <tr>
                                    <td class="td-with-icon"><img src="img/tile.svg" alt="" loading="lazy" decoding="async" class="w-10 h-10 object-fit-contain" width="12" height="12"></td>
                                    <td>Piętro</td>
                                    <td class="text-end">Parter</td>
                                </tr>
                                <tr>
                                    <td class="td-with-icon"><img src="img/blueprint.svg" alt="" loading="lazy" decoding="async" class="w-10 h-10 object-fit-contain" width="12" height="12"></td>
                                    <td>Metraż</td>
                                    <td class="text-end">83,78 m<sup>2</sup></td>
                                </tr>
                                <tr>
                                    <td class="td-with-icon"><img src="img/rooms.svg" alt="" loading="lazy" decoding="async" class="w-10 h-10 object-fit-contain" width="12" height="12"></td>
                                    <td>Liczba Pokoi</td>
                    ...
                    <div class="invest-card-horizontal-right">
                        <img src="img/investment_plan.png" alt="" loading="lazy" decoding="async" class="w-100 h-100 object-fit-contain" width="440" height="310">
                    </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="row row-gap-4">
                        <div class="col-12 col-md-6 text-center order-last order-md-first">
                            <img src="img/home_o_firmie.webp" alt="" width="321" height="471" loading="lazy" decoding="async" data-aos="fade" class="img-fluid rounded">
                        </div>

                        <div class="col-12 col-md-6">
                            <div style="--translate-x: -3%;" class="position-relative text-center d-flex flex-column justify-content-center align-items-center section-header text-secondary">
                                <div class="position-absolute top-50 start-50 translate-middle z-2">
                                    <img src="img/sygnet_secondary.svg" alt="" width="168" height="168" loading="lazy" decoding="async" data-aos="fade">
                                </div>
                                <h2 class="fw-bold text-center text-uppercase">
                ...
                <div class="col-12 col-lg-5 offset-lg-1">
                    ...
                    <div class="row row-gap-4 pt-40 mt-lg-4">
                        ...
                        <div class="col-12 col-sm-6">
                            <div class="d-flex flex-column align-items-center text-center text-lg-start align-items-lg-start row-gap-4" data-aos="fade">
                                <div class="d-inline-flex rounded-circle bg-white p-2 justify-content-center align-items-center shadow" style="width: 87px; height: 87px; --bs-box-shadow:0 3px 30px rgba(0, 0, 0, 0.1);">
                                    <img src="<?php echo $item['svg_url']; ?>" alt="" width="45" height="45" loading="lazy" decoding="async">
                                </div>
