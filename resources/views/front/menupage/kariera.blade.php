...
@section('content')
    <main class="with-bigger-section-spacing">
        ...
        @include('layouts.partials.page-header', ['h1' => 'Podstrona', 'desc' => 'Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor.', 'header' => 'img/kariera_bg.webp', 'mb' => 100])
                ...
                <div class="row row-gap-4">
                    <div class="col-12 col-md-6 col-lg-5">
                        ...
                        <div class="text-pretty mt-4 mt-md-40" data-aos="fade">
                            <p>
                                Dobrze dobrany zespół potrafi sprostać stawianym mu wyzwaniom, wzajemnie się wspierać, wspólnie rozwiązywac problemy i nawzajem się inspirować.
                            </p>
                            <p>
                            ...
                            <p>
                                Naszą siłą jest różnorodność naszych wspólnych doświadczeń, kreatywność w rozwiązywaniu problemów i wzajemna pomoc zwłaszcza osobom nowozatrudnionym.
                            </p>
                    ...
                    <div class="col-12 col-md-6 col-lg-5 offset-lg-2">
                        <div class="w-100 h-100" data-aos="fade">
                            <img class="img-fluid rounded" src="{{asset('img/kariera_s1.webp')}}" alt="" width="555" height="471" loading="eager">
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="accordion" id="accordionPanelsStayOpenExample" data-aos="fade">
                            <div class="accordion-item shadow-post-article mb-30">
                                <h2 class="accordion-header">
                                    <button class="accordion-button fs-24" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
                                        Specjalista Ds. Nieruchomości
                                    </button>
                                </h2>
                                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show">
                                    <div class="accordion-body">
                                        <p>Zawiążemy współpracę ze specjalistą do spraw nieruchomości, którego zadaniem byłoby poszukiwanie nowych gruntów pod inwestycje deweloperskie (budownictwo mieszkaniowe wielorodzinne) w rejonie Warszawy i Białegostoku. </p>
                                        <p class="fw-semibold fs-5 text-secondary pt-4 mb-2">Zadania</p>
                                        <ul>
                                            <li class="mb-2">poszukiwanie nowych nieruchomości gruntowych pod zabudowę mieszkaniową,</li>
                                            <li class="mb-2">zbieranie informacji na temat lokalizacji, powierzchni, planu miejscowego lub studium,</li>
                                            <li class="mb-2">sporządzanie i przedstawianie Spółce zebranych informacji na temat nieruchomości,</li>
                                            <li class="mb-2">udział w negocjacjach ze Sprzedającym</li>
                                        </ul>
                                        <p class="fw-semibold fs-5 text-secondary pt-4 mb-2">Oferujemy</p>
                                        <p>Oferujemy atrakcyjne wynagrodzenie prowizyjne ustalane na podstawie efektów wykonanej pracy. </p>
                                        <div class="pt-4 pt-md-40">
                                            <a href="#aplikuj" class="btn btn-primary btn-with-icon min-w-max-content flex-fill d-inline-flex align-items-center justify-content-center gap-1">
                                                Aplikuj
                            ...
                            <div class="accordion-item shadow-post-article">
                                <h2 class="accordion-header">
                                    <button class="accordion-button collapsed fs-24" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                ...
                <div class="row row-gap-4">
                    ...
                    <div class="col-12 col-md-6 col-lg-5 offset-lg-2 offset-xl-3">
                        <div class="apply-form-container text-secondary" data-aos="fade">
                            ...
                            <form id="apply-form" autocomplete="off" class="contact-form">
                                <div class="row">
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        <div class="mb-1">
                                            <label for="form-file" class="form-label cursor-pointer d-inline-flex gap-3 align-items-center" role="button" tabindex="0">
                                                <img src="{{asset('img/attachment.svg')}}" alt="" width="10" height="19" loading="lazy" decoding="async">
                                                Załącz CV
                                            </label>
                                            <input class="form-control d-none" type="file" id="form-file" name="cv">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-check text-start pb-4 pb-md-5">
                                        ...
                                        <label class="form-check-label small fw-medium" for="terms-check">
                                            Akceptuję
                                            <a class="link-hover-primary text-decoration-underline" href="/polityka-prywatnosci.html">politykę
                                                prywatności.</a>
