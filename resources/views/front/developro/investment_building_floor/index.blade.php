                                        ...
                                        @foreach($properties as $r)
                                            @if($r->html)
                                                <area
                                                        ...
                                                        data-item="{{$r->id}}"
                                                        title="{{$r->name}}<br>Powierzchnia: <b class=fr>{{$r->area}} m<sup>2</sup></b><br />Pokoje: <b class=fr>{{$r->rooms}}</b><br><b>{{ roomStatus($r->status) }}</b><br>@if($r->price_brutto && $r->status == 1 && !$r->highlighted) @money($r->price_brutto)</p> <span class=small>@money(($r->price_brutto / $r->area)) / m<sup>2</sup></span> @endif @if($r->price_brutto && $r->status == 1 && $r->highlighted) @money($r->promotion_price) <span class=small>@money(($r->promotion_price / $r->area)) / m<sup>2</sup></span> @endif"
                                                        alt="{{$r->slug}}"
