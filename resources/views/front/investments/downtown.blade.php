                            ...
                            <div class="text-pretty mt-4 mt-md-40" data-aos="fade">
                                ...
                                <div class="mt-4">
                                    <a class="btn btn-primary btn-with-icon text-nowrap"
                                        href="#link_do_mieszkań_2_pokojowych">Mieszkania 2-POK<svg
                    ...
                    <div class="row row-gap-4 align-items-center">
                        <div class="col-12 col-md-6 col-lg-5">
                            ...
                            <div class="text-pretty mt-4 mt-md-40" data-aos="fade">
                                ...
                                <div class="mt-4">
                                    <a class="btn btn-primary btn-with-icon text-nowrap" href="#mieszkania">Zobacz
                        ...
                        <div class="col-12 col-md-6">
                            <ul class="mb-0">
                                ...
                                <li>
                                    <div class="d-inline-flex justify-content-between gap-3 w-100">
                                        <p>
                                            Deptak ul. Piotrkowska: Najdłuższa w Polsce ulica handlowa
                                        </p>
                                        <p class="text-secondary">
                                            900m
                                        </p>
                        ...
                        <div class="col-12 col-md-6">
                            <ul>
                                ...
                                <li>
                                    <div class="d-inline-flex justify-content-between gap-3 w-100">
                                        <p>
                                            Off Piotrkowska: Pasaż gastronomiczno-rozrywkowy
                                        </p>
                                        <p class="text-secondary">
                                            900m
                                        </p>
