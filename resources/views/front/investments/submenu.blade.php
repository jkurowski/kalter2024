@php
    ...
    if (request()->routeIs('developro.show')) {
        $links = collect([
            ['id' => '1', 'class' =>'scroll', 'title' => 'Opis inwestycji', 'href' => '#opis-inwestycji'],
            ['id' => '2', 'class' =>'', 'title' => 'Wyszukaj z rzutu', 'href' => route('developro.plan', $investment->slug).'?status=1#invesmentplan'],
            ['id' => '3', 'class' =>'', 'title' => 'Wyszukaj z modelu 3D', 'href' => route('developro.mockup', $investment->slug).'#smart-makieta'],
            ['id' => '4', 'class' =>'scroll', 'title' => 'Lokalizacja', 'href' => '#lokalizacja'],
            ['id' => '5', 'class' =>'scroll', 'title' => 'Atuty', 'href' => '#atuty'],
            ['id' => '6', 'class' =>'', 'title' => 'Dziennik inwestycji', 'href' => route('developro.investment.news', $investment->slug)],
        ...
        ->map(function ($link) use ($activeMenuId) {
            ...
            $links = collect([
            ['id' => '1', 'class' =>'scroll', 'title' => 'Opis inwestycji', 'href' => route('developro.show', $investment->slug).'#opis-inwestycji'],
            ['id' => '2', 'class' =>'', 'title' => 'Wyszukaj z rzutu', 'href' => route('developro.plan', $investment->slug).'?status=1#invesmentplan'],
            ['id' => '3', 'class' =>'', 'title' => 'Wyszukaj z modelu 3D', 'href' => route('developro.mockup', $investment->slug).'#smart-makieta'],
