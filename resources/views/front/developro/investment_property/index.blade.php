                                ...
                                <p class="h4 mb-1 ff-secondary row">
                                    <span class="col-12">
                                        @if($property->price_brutto && $property->area)
                                            <span class="fs-5 d-block">Szacowane ceny od: @money(($property->price_brutto / $property->area)) / m<sup>2</sup></span>
                                        @endif
                                    </span>
                                </p>
                            @endif
                    ...
                    modalElement.addEventListener('shown.bs.modal', () => {
                        ...
                        if (!modalElement.dataset.selectBound) {
                            $('.selectpicker').on('changed.bs.select', function (e, clickedIndex, isSelected, previousValue) {
                                ...
                                const url = baseUrl + `pl/przynalezne/${selectedValue}/show/`;
                        ...
                        if (!addBtn.dataset.bound) {
                            addBtn.addEventListener('click', () => {
                                ...
                                const url = baseUrl + `pl/przynalezne/${surfaceId}/table/`;
